...
export default function PostCard({ post, showAuthor = true }: PostCardProps) {
  ...
  return (
    <article className="group bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800 hover:shadow-xl dark:hover:shadow-2xl dark:hover:shadow-gray-900/50 transition-all duration-300">
      {/* Image */}
